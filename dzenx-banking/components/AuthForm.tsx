        ...
        <>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              {/*this operation makes it posible to show more
               inputs for the SIGN UP FORM*/}
              ...
              {type === "sign-up" && (
                <>
                  ...
                  <CustomInput
                    ...
                    name="address1"
                    label="Address"
                    ph="Enter your spesific address"
                  />
                  <CustomInput
                    control={form.control}
                    name="city"
